...
package
{
   ...
   * trace (corners.left, corners.bottom, corners.right, corners.top);
   *
   * TODO:
   ...
   **/
	...
	public class FindCorners
	{
		...
		{
			if (stage.fullScreenWidth/stageFullScreenHeight > stage.stageWidth/stage.stageHeight)
				displayType = "wider"
			else
				displayType = "taller"
		}
		...
		private function findCorners(s:Stage):Number
		{
			...
			if (displayType == "wider")
			{
				scaleProportion = stageFullScreenHeight/s.stageHeight;			
			...
			else
			{
				...
				scaleProportion = Math.round((stageFullScreenHeight - stage.stageHeight*scaleProportion)/2 / scaleProportion);
			}
